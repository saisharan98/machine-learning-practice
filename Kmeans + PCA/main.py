...
print('#################')
print('Project data into %d dimensions with PCA converged in %d iteration (%.2f seconds)'%(num_dim_90,num_iter_pca,time_pca))
print('Contingency Matrix:')
